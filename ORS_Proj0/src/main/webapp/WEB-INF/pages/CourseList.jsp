		...
		<div class="container">
			<div class="row">
				<div class="col-md-2 col-md-offset-5">
					<sf:input path="courseName" placeholder="Name" class="form-control" />
				</div>
				<div class="col-md-1">
				...
				<div class="col-md-1">
					<a class="form-control btn btn-primary"
						href="<c:url value="/ctl/Course/search"></c:url>"><s:message
					...
					<table class="table table-bordered table-condensed table-hover">
						<thead>
							<tr id="trcolor">
								...
								<th id="thcolor"><s:message code="label.courseName"></s:message></th>
								<th id="thcolor"><s:message code="label.courseDescription"></s:message></th>
								<th id="thcolor"><s:message code="label.duration"></s:message></th>
								<c:if test="${sessionScope.user.roleId==1 }">
						...
						<c:forEach items="${list }" var="course">
							<tbody>
								<tr>
									...
									<c:if test="${sessionScope.user.roleId==1 }">
										<td><c:url value="/ctl/Course" var="edit">
