			...
			<div class="row">
				...
				<div class="col-md-1">
					<a class="form-control btn btn-primary"
						href="<c:url value="/ctl/Marksheet/search"></c:url>"><s:message
			...
			<c:when test="${not empty list }">
				<div class="table-responsive">
					<table class="table table-bordered table-condensed table-hover">
						...
						<c:forEach items="${list }" var="marksheet">
							<tbody>
								<tr>
									<c:if test="${sessionScope.user.roleId==1 }">
									...
									<td>${marksheet.maths +marksheet.chemistry+marksheet.physics}</td>
									<c:if test="${sessionScope.user.roleId==1 }">
										<td><c:url value="/ctl/Marksheet" var="edit">
												<c:param name="id" value="${marksheet.id}"></c:param>
