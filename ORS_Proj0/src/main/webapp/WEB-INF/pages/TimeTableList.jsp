			...
			<div class="row">
				<div class="col-md-2 col-md-offset-3">
					<sf:select path="courseId" cssClass="form-control">
						<sf:option value="0">Course</sf:option>
						<sf:options items="${courseList}" itemLabel="courseName"
							itemValue="id"></sf:options>
					</sf:select>


				</div>
				<div class="col-md-2 col-md-offset-1">
					<sf:input path="subject" placeholder="Subject"
				...
				<div class="col-md-1">
					<a class="form-control btn btn-primary"
						href="<c:url value="/ctl/TimeTable/search"></c:url>"><s:message
					...
					<table class="table table-bordered table-condensed table-hover">
						<thead>
							<tr id="trcolor">
								...
								<th id="thcolor"><s:message code="label.course"></s:message></th>
								<th id="thcolor"><s:message code="label.subject"></s:message></th>
								<th id="thcolor"><s:message code="label.examDate"></s:message></th>
								<c:if test="${sessionScope.user.roleId==1 }">
						...
						<c:forEach items="${list }" var="timeTable">
							<tbody>
								<tr>
									<c:if test="${sessionScope.user.roleId==1 }">
										<td id="thcolor"><input type="checkbox"
											class="mycheckbox" name="ids" value="${timeTable.id }"></td>
									</c:if>
									<td>${index}</td>
									<td>${timeTable.courseName }</td>
									<td>${timeTable.subject }</td>
									<td><fmt:formatDate value="${timeTable.examDate }"
											type="DATE" dateStyle="FULL" /></td>
									<c:if test="${sessionScope.user.roleId==1 }">
										<td id="thcolor"><c:url value="/ctl/TimeTable" var="edit">
												<c:param name="id" value="${timeTable.id}"></c:param>
