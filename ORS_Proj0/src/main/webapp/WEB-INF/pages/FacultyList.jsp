	...
	<sf:form action="search" method="post" commandName="form">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-2 col-md-offset-1">
					<sf:input path="emailId" placeholder="Email ID"
				...
				<div class="col-md-1">
					<a class="form-control btn btn-primary"
						href="<c:url value="/ctl/Faculty/search"></c:url>"><s:message
						...
						<c:forEach items="${list }" var="faculty">
							<tbody>
								<tr>
									...
									<c:if test="${sessionScope.user.roleId==1 }">
										<td><c:url value="/ctl/Faculty" var="edit">
												<c:param name="id" value="${faculty.id}"></c:param>
