		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-2 col-md-offset-1">
					<sf:input path="state" cssClass="form-control" placeholder="State" />
				</div>
				...
				<div class="col-md-1">
					<a class="form-control btn btn-primary"
						href="<c:url value="/ctl/College/search"></c:url>"><s:message
					...
					<table class="table table-bordered table-condensed table-hover">
						<thead>
							<tr id="trcolor">
								...
								<th id="thcolor"><s:message code="label.address"></s:message></th>
								<th id="thcolor"><s:message code="label.state"></s:message></th>
								<th id="thcolor"><s:message code="label.city"></s:message></th>
								<th id="thcolor"><s:message code="label.phoneNo"></s:message></th>
								<c:if test="${sessionScope.user.roleId==1 }">
						...
						<c:forEach items="${list }" var="college">
							<tbody>
								<tr>
									...
									<c:if test="${sessionScope.user.roleId==1 }">
										<td><c:url value="/ctl/College" var="edit">
												<c:param name="id" value="${college.id}"></c:param>
