	...
	<div class="container">
		<sf:form action="Faculty" method="post" commandName="form"
			...
			<div class="text-center">
				...
				<c:if test="${form.id==0 }">
					<h1 class="text-primary">
						<s:message code="label.addFaculty"></s:message>
					</h1>
				</c:if>
				...
				<div class="form-group row">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							...
							<sf:select path="collegeId" cssClass="form-control">
								<sf:option value="0">Select</sf:option>
								<sf:options items="${collegeList }" itemLabel="name"
				...
				<div class="form-group row">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							...
							<sf:input path="dob" id="datepicker" cssClass="form-control"
