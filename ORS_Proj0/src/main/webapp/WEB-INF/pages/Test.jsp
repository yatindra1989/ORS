						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<c:if test="${sessionScope.user.roleId == 1}">
									<li><a href="<c:url value="#" />" target="_blank"><span
											class="glyphicon glyphicon-book"></span> <s:message
												code="label.javaDoc"></s:message></a></li>
								</c:if>
					...
					<c:if test="${not empty sessionScope.user}">
						...
						<c:if test="${sessionScope.user.roleId == 2}">
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								...
								<ul class="dropdown-menu">
									<li><a href="<c:url value="/ctl/Marksheet" />">Add
											Marksheet</a></li>
									<li><a href="<c:url value="/ctl/GetMarksheet" />">Get
											Marksheet</a></li>
									<li><a href="<c:url value="/Login" />"> Marksheet
											Merit List</a></li>
								</ul></li>
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								data-toggle="dropdown" role="button" aria-haspopup="true"
								...
								<ul class="dropdown-menu">
									<li><a href="<c:url value="/ctl/CollegeList" />">
											College List</a></li>
								</ul></li>
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								data-toggle="dropdown" role="button" aria-haspopup="true"
								...
								<ul class="dropdown-menu">
									<li><a href="<c:url value="/CourseList" />"><span
							...
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								...
								<ul class="dropdown-menu">
									<li><a href="<c:url value="/TimeTable" />"><span
											class="glyphicon glyphicon-list-alt"></span> Time Table List</a></li>
								</ul></li>
						</c:if>
						...
						<c:if test="${sessionScope.user.roleId == 3}">
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								...
								<ul class="dropdown-menu">
									...
									<li><a href="<c:url value="/Login" />"><span
											class="glyphicon glyphicon-search"></span> Get Marksheet</a></li>
									<li><a href="<c:url value="/Login" />"><span
											class="glyphicon glyphicon-sort-by-attributes-alt"></span>
											Marksheet Merit List</a></li>
								</ul></li>
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								data-toggle="dropdown" role="button" aria-haspopup="true"
								aria-expanded="false">College <span class="caret"></span></a>
